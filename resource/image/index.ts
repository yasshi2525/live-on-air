...
const main = (): AssetsParameters => [
  ...
  createText({ name: 'broadcaster.default', text: 'Broadcaster', size: 30, color: 0xaaaaff, strokeWidth: 10, blur: true }),
  ...
  createText({ name: 'layer.comment.label', text: 'comment', size: 25, color: 0x000000, stokeColor: 0xffffff }),
  createText({ name: 'layer.header.label', text: 'header', size: 25, color: 0x000000, stokeColor: 0xffffff })
]
